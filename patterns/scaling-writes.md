...
[Job Scheduler](https://www.hellointerview.com/learn/system-design/problem-breakdowns/job-scheduler#scaling-writes)
...
[Notification System](https://www.hellointerview.com/learn/system-design/problem-breakdowns/notification-system#scaling-writes)

[Flash Sale](https://www.hellointerview.com/learn/system-design/problem-breakdowns/flash-sale#scaling-writes)
...
There's a good chance hardware can go further than you think! Systems with 200 CPU cores and 10gigabit network interfaces are not uncommon. It's worth brushing up on some [Numbers to Know](https://www.hellointerview.com/learn/system-design/core-concepts/numbers-to-know) to make sure you're not missing out on a lot of potential.
...
By doing so, we've spread our data across all of the servers in the cluster. Another approach is to use a [consistent hashing](https://www.hellointerview.com/learn/system-design/core-concepts/consistent-hashing) scheme to determine which server to write to.

##### Selecting a Good Partitioning Key

In practice, interviewers are expecting you to say "[sharding](https://www.hellointerview.com/learn/system-design/core-concepts/sharding)" but they want to know *how* that's going to work. The most important detail you'll want to share is how to **select a partitioning key**. If you've chosen a good key (say, hashing the userID), all of your data will be spread *evenly* across the cluster, so that we've solved the problem and realized our hypothetical gain of 10x by multiplying the number of servers by 10.
...
And while we *might* be able to scale our database to handle the increased load (and backlog we've accumulated in the queue), scaling isn't instant. Until the backlog drains, users are still waiting on writes we already told them we accepted.
...
## [In the Wild](https://www.hellointerview.com/learn/system-design/in-the-wild?pattern=scaling-writes)

* [5 Techniques Meta Uses to Scale a Database to Millions of Clients](https://www.hellointerview.com/learn/system-design/in-the-wild/meta-zgateway-zippydb)
...
* [![Slack](https://www.hellointerview.com/_next/static/media/slack.3ifu5_ng7dxey.svg?dpl=496e216d3ce87e7f3171c9d940be7a9f2d93afb8)How Slack Put Kafka in Front of Its Redis Job Queue](https://www.hellointerview.com/learn/system-design/in-the-wild/slack-job-queue)
...
[Next: Handling Large Blobs](https://www.hellointerview.com/learn/system-design/patterns/large-blobs)
