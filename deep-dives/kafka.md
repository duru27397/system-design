...
How to use Kafka in system design interviews: partitions and consumer groups, message ordering, retries, hot partitions, and exactly-once delivery.
...
[Next: API Gateway](https://www.hellointerview.com/learn/system-design/deep-dives/api-gateway)
