...
How to use Cassandra in system design interviews: partition and clustering key data modeling, tunable consistency, and when to use it over other databases.
...
One of the most important constructs in Cassandra is the "primary key" of a table. Every row is identified by a primary key. A primary key consists of one or more partition keys and may include clustering keys. Let's break down what these terms mean.
...
When introducing Cassandra in a system design interview, you're going to want to know more than just how to use it. You'll want to be able to explain how it works in case your interviewer asks pointed questions, or you might want to deep dive into data storage specifics, scalability, query efficiency, etc., all of which affect your design. In this section, we dive into the essential details of Cassandra to give you this context.
...
The above schema enables Cassandra to service messages for a channel via *a single partition*. The partition key, channel\_id, ensures that a single partition is responsible for servicing the query, preventing the need to do a "scatter-gather" query across several nodes to get message data for a channel, which could be slow / resource intensive.
...
![Ticketmaster venue map with section popovers](https://www.hellointerview.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcassandra-1.0xy3zvnvvj4k4.png&w=1920&q=75&dpl=496e216d3ce87e7f3171c9d940be7a9f2d93afb8)

If a user clicks into a section of interest, Ticketmaster's UI then shows the individual seats and ticket information.

![Ticketmaster individual seat view](https://www.hellointerview.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcassandra-2.2ve2ifzbgu-3j.png&w=3840&q=75&dpl=496e216d3ce87e7f3171c9d940be7a9f2d93afb8)
...
[Next: DynamoDB](https://www.hellointerview.com/learn/system-design/deep-dives/dynamodb)
